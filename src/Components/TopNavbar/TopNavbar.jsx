...
function TopNavbar() {
  ...
  return (
    <>
      <header style={{position: 'sticky',top: '0', background: 'white', zIndex: '99'}} className="border-b-1 relative z-20 w-full border-b border-slate-200 bg-white/90 shadow-lg shadow-slate-700/5 after:absolute after:top-full after:left-0 after:z-10 after:block after:h-px after:w-full after:bg-slate-200 lg:border-slate-200 lg:backdrop-blur-sm lg:after:hidden">
        <div className="relative mx-auto max-w-full px-6 lg:max-w-5xl xl:max-w-7xl 2xl:max-w-[96rem]">
          ...
          >
            <a
              ...
              href="#"
            >
            <img style={{width: '40px', height: '40px', borderRadius: '50%'}} src="public/images/restarent-logo.png" alt="LOGO" />
             Syed Brand
            </a>
            <button
            ...
            <div className="ml-auto flex items-center justify-end px-6 lg:ml-0 lg:flex-1 lg:pr-6">
              <Link to='/cart-page'
                href="#"
            ...
            {/* <div style={{marginTop: '-5px'}} className="ml-auto flex items-center px-6 lg:ml-0 lg:p-0">
              <a
                href="#"
                className="relative inline-flex h-10 w-10 items-center justify-center rounded-full text-white"
              >
                <button style={{background: 'white'}} onClick={() => setIsOpen(!isOpen)}>
                    <div>
                        <img
                        src="public/images/My_photo.png"
                        alt="user name"
                        title="user name"
                        width="40"
                        height="40"
                ...
                {isOpen && (
                    <Link to='/login'><div style={{color: 'black', position: 'absolute', top: '3rem', right: '-2.1rem', borderTop: '0.1px solid gray', background: 'white', padding: '0.6rem 2rem', borderRadius: '0 0 16px 16px'}}>Logout</div></Link>
                )}
              </a>
            </div> */}
          </nav>
